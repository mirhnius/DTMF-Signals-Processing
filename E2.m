[y,fs] = audioread('studentNumber.wav'); % discrete signal and its sampling frequency HERE find one DTMF period (start: sample n1, end: sample n2)
figure(1);
plot(y);
tsig = (abs(y) >0);
dsig = diff([1; tsig ;1]);
